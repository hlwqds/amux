...
- [x] **S01: Foundation - lib.rs split and lint fixes** `risk:low` `depends:[]`
...
- [x] **S02: app.rs decomposition into sub-modules** `risk:high` `depends:[S01]`
...
- [x] **S03: Test migration to per-module locations** `risk:medium` `depends:[S01,S02]`
